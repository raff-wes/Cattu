...
switch(bg){
	...
	default: document.getElementById("bgchange").style.backgroundImage = "linear-gradient(135deg, orange, lightblue, darkblue, black)";
			 document.getElementById("tlo").innerHTML = "Coś poszło nie tak przy wczytywaniu obrazka :(<br> Spróbuj odświeżyć stronę";
			 document.getElementById("tlo").style.pointerEvents = "none"; break;
}
